...
/// 2003 / 12 / 1 / ������
/// ����)
///		1. �� operation�ȿ��� Initialize�� CoUninitialize�� ����ϸ� return�� �����߻�
///			:	IXMLDOMNodePtr�� ����Ʈ �����Ϳ��� ���� ��������. scope�� ����� �����Ǳ� ������ �߻���.
///				IXMLDoMNode(raw pointer)�� �����Ͽ� ���� �ذ��� => �ٽ� ���� �߻� :�̸� �� ������
//////////////////////////////////////////////////////////////////////////////////////
...
//		sFileName.append(".XML");
	...
	catch( int ei )
	{
		...
		{
		case 2:
			sprintf(szMsg,"XML�� UI������ ���� �߻�:%s",IDD );			
			break;
		case 3:
			sprintf(szMsg,"%s.XML ������ ã���� �����ϴ�. Ȯ���� �ּ���.",IDD );			
			break;
		}
		MessageBox( NULL,szMsg,"Error",MB_OK );
	}
