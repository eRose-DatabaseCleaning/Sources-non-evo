vs.1.1
//---------------------------------------------------------------
// terrain vertex shader for roughmap
...
// c17 = C_ALPHAFOG_START_END_FACTOR = [alpha_fog_start, alpha_fog_end, 1/(alpha_fog_end - alpha_fog_start), 0]
// c19 = C_FOG_START_END_FACTOR = [fog_start, fog_end, 1/(fog_end - fog_start), 0]
// ...
