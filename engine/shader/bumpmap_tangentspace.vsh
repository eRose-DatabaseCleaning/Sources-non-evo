...
m4x3 r4.xyz, V_POSITION, C_WORLDVIEW_TM // apply worldview matrix
m3x3 r5.xyz, V_NORMAL, C_WORLDVIEW_TM // r5 = normal transform
...
// r4 = r5 x (r3)
//-------------------------------------------------
mul r0, r5.zxy, r3.yzx
mad r4, r5.yzx, r3.zxy, -r0
...
m4x3 r2.xyz, V_POSITION, C_WORLDVIEW_TM// transform position
...
//mov r2, C_LIGHT_DIRECTION
//m3x3 r2, r2, C_WORLDVIEW_TM
//add r2.xyz, r2.xyz, C_LIGHT_DIRECTION		// to get half angle
m4x3 r2.xyz, V_POSITION, C_WORLDVIEW_TM
mov r3, C_LIGHT_DIRECTION
m4x3 r1.xyz, r3, C_WORLDVIEW_TM
add r2, -r2, r1
...
// r2 = to-screen vector (0, 0, 1, 0)
//mov r2.xyzw, C_ONE_HALF_ZERO_MAXPOWER.zzxz
...
// for tangent vector test
//mad oD0.xyz, r3.xyz, C_ONE_HALF_ZERO_MAXPOWER.yyyy, C_ONE_HALF_ZERO_MAXPOWER.yyyy // multiply by a half to bias, then add half	
//mad oD1.xyz, r4.xyz, C_ONE_HALF_ZERO_MAXPOWER.yyyy, C_ONE_HALF_ZERO_MAXPOWER.yyyy // multiply by a half to bias, then add half	

// r8[-1..1] -> oD1[0..1]
// oD1 = r8 / 2 + 1/2
//mad oD1.xyz, r8.xyz, C_ONE_HALF_ZERO_MAXPOWER.yyyy, C_ONE_HALF_ZERO_MAXPOWER.yyyy // multiply by a half to bias, then add half	
mad oD0.xyz, r2.xyz, C_ONE_HALF_ZERO_MAXPOWER.yyyy, C_ONE_HALF_ZERO_MAXPOWER.yyyy // multiply by a half to bias, then add half	

// set normalization texture coord by light term
mad oT2.xyz, r8.xyz, C_ONE_HALF_ZERO_MAXPOWER.yyyy, C_ONE_HALF_ZERO_MAXPOWER.yyyy // multiply by a half to bias, then add half	
mov oT2.w, C_ONE_HALF_ZERO_MAXPOWER.x
