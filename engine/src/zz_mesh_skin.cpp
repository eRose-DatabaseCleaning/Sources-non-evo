/** 
 * @file zz_mesh_skin.cpp
 * @brief skinned mesh
 * @author Jiho Choi (zho@korea.com)
 * @version 1.0
 * @date    05-mar-2002
 *
 * $Header: /engine/src/zz_mesh_skin.cpp 1     04-06-22 9:53a Zho $
 * $History: zz_mesh_skin.cpp $
 * 
 * *****************  Version 1  *****************
...
#include "zz_mesh_skin.h"

ZZ_IMPLEMENT_DYNCREATE(zz_mesh_skin, zz_mesh)

zz_mesh_skin::zz_mesh_skin(void)
{
}
